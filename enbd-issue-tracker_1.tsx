...
const SEED = [
  ...
  {"case":"00984716","sfId":"500a6000014sIwSAAU","subject":"Custom regex  update in the ENBD production tenant","status":"Awaiting Customer","priority":"Severity 3","isClosed":false,"created":"07 Apr 2026","closed":null,"owner":"Freddy Tharakan","component":null,"resNotes":null,"latestSfNote":null,"desc":"Ref Case  : 00935675\r\n- Latest Regex provided by Engineering Need to be applied  to production Tenant.","sfCategory":"open","isUpgrade":false,"suggestion":""},
    ...
    <div style={st.wrap}>
      ...
      <div style={{padding:"14px 16px 60px"}}>
        ...
        <div style={{marginTop:10,fontSize:9,color:C.inkSoft,fontFamily:"monospace",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          <span>Forcepoint DSPM · Emirates NBD · AccountId: 0015f00000R7aqFAAR · {allCases.length} cases{addedCases.length>0?` · ${addedCases.length} added`:""} · {filtered.length} shown · synced 13 Apr 2026</span>
