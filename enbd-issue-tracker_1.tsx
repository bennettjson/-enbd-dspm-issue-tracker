    ...
    <div style={st.wrap}>
      ...
      <div style={{padding:"14px 16px 60px"}}>
        ...
        <div style={{marginTop:10,fontSize:9,color:C.inkSoft,fontFamily:"monospace",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          <span>Forcepoint DSPM · Emirates NBD · AccountId: 0015f00000R7aqFAAR · {allCases.length} cases{addedCases.length>0?` · ${addedCases.length} added`:""} · {filtered.length} shown · synced 23 Apr 2026</span>
