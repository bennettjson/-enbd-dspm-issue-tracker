...
// ─── SEED DATA ────────────────────────────────────────────────────────────────
const SEED = [
  {"case":"00990404","sfId":"500a6000017hRA5AAM","subject":"Unable to Copy paste due to Forcepoint DLP","status":"Awaiting Customer","priority":"Severity 3","isClosed":false,"created":"22 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Endpoint - DLP","resNotes":null,"latestSfNote":null,"desc":"Unable to Copy paste due to Forcepoint DLP, we have reinstalled Forcepoint agent still the issue remains same on the agent level.","sfCategory":"open","isUpgrade":false,"suggestion":""},
  {"case":"00989450","sfId":"500a6000017GvQnAAK","subject":"Enable 'Customizable File Upload Blocking' feature flag for ENBD","status":"Response received from Customer","priority":"Severity 3","isClosed":false,"created":"20 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Cloud - Web","resNotes":null,"latestSfNote":null,"desc":"Enable 'Customizable File Upload Blocking' feature flag for ENBD test Tenant [Account ID - 83465].","sfCategory":"open","isUpgrade":false,"suggestion":""},
  {"case":"00987881","sfId":"500a6000016RE7lAAG","subject":"User not able to access internet — account not syncing via SCIM","status":"Closed","priority":"Severity 2","isClosed":true,"created":"15 Apr 2026","closed":"16 Apr 2026","owner":"Freddy Tharakan","component":"Cloud - Web","resNotes":null,"latestSfNote":null,"desc":"User RahulVA@emiratesnbd.com not present on Forcepoint — SCIM provision fails with 'user already in database' error. User unable to browse internet.","sfCategory":"resolved","isUpgrade":false,"suggestion":""},
  {"case":"00986296","sfId":"500a6000015a07mAAA","subject":"Need removal tool to remove DLP from user machines","status":"Awaiting Internal Response","priority":"Severity 3","isClosed":false,"created":"10 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Endpoint - DLP","resNotes":null,"latestSfNote":null,"desc":"Removal tool required for DLP on 200+ corrupted machines. PS tool insufficient for bulk bank environment with 30k users. Manual command line methods not efficient at scale.","sfCategory":"open","isUpgrade":false,"suggestion":""},
  {"case":"00986287","sfId":"500a6000015ZorPAAS","subject":"LDAP import stuck and failed","status":"Awaiting Customer","priority":"Severity 3","isClosed":false,"created":"10 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Configuration - DSPM","resNotes":null,"latestSfNote":null,"desc":"LDAP import stuck and failed.","sfCategory":"open","isUpgrade":false,"suggestion":""},
  ...
  {"case":"00984716","sfId":"500a6000014sIwSAAU","subject":"Custom regex  update in the ENBD production tenant","status":"Closed","priority":"Severity 3","isClosed":true,"created":"07 Apr 2026","closed":"16 Apr 2026","owner":"Freddy Tharakan","component":null,"resNotes":"New updated regex applied to ENBD Production Tenant.","latestSfNote":"ENBD: unable to close on their side — FP can proceed to close — 16 Apr 2026","desc":"Ref Case  : 00935675\r\n- Latest Regex provided by Engineering Need to be applied  to production Tenant.","sfCategory":"resolved","isUpgrade":false,"suggestion":""},
  {"case":"00984339","sfId":"500a6000014jTUWAA2","subject":"Forcepoint not detecting sensitive data in modified file types","status":"Closed - Unconfirmed Resolved","priority":"Severity 3","isClosed":true,"created":"06 Apr 2026","closed":"20 Apr 2026","owner":"Forcepoint TS","component":"Classification - DLP","resNotes":null,"latestSfNote":null,"desc":"Magic number prepended to sensitive data in text file — DLP not detecting content, no incident generated. HTML basic code with sensitive data saved as .xsxl.html bypasses DLP detection across all channels including email and web.","sfCategory":"unconfirmed","isUpgrade":false,"suggestion":"Two bypass vectors: (1) Magic number injection — KeyView signature-based format detection misclassifies file type. Verify DLP content extraction falls back to text parsing when magic number is invalid. (2) Double extension .xsxl.html — DLP parses as HTML and misses embedded sensitive data. Raise with Engineering if confirmed reproducible."},
  {"case":"00984296","sfId":"500a6000014jdAVAAY","subject":"Move RBI tenant to AWS Frankfurt region (eu-central-1)","status":"Awaiting Internal Response","priority":"Severity 2","isClosed":false,"created":"06 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Cloud - Web","resNotes":null,"latestSfNote":null,"desc":"Regulatory approval received to move RBI tenant to AWS Frankfurt (eu-central-1) due to AWS Middle East region issues. Prod tenant: 166f0064-7dd4-4355-a518-36b7b5a476a2. UAT tenant: c165e04d-1016-4246-94d5-1bad90d4fe40.","sfCategory":"open","isUpgrade":false,"suggestion":""},
  {"case":"00983655","sfId":"500a6000014E33HAAS","subject":"UTC time on reports needs to be converted to GST","status":"Closed - Unconfirmed Resolved","priority":"Severity 2","isClosed":true,"created":"02 Apr 2026","closed":"17 Apr 2026","owner":"Nathan Borowicz","component":"Configuration - DSPM","resNotes":"Hi Nisha,\r\n\r\nThanks for the details.\r\n\r\nIt is not feasible to export the report in different timezone. I have raised an Feature request for this requirement. FR202604-1780 for your reference.\r\n\r\nAs a workaround you can use the excel formula to convert the UTC time to GST time. Below is the example for your reference \r\n\r\nUTC                             Formula                   GST (UTC+4)\r\n07-Apr-2026 08:30     =A1+TIME(4,0,0)     07-Apr-2026 12:30","latestSfNote":"FR202604-1780 raised. Excel workaround provided — 07 Apr 2026","desc":"UTC time on reports needs to be converted to GST","sfCategory":"unconfirmed","isUpgrade":true,"suggestion":"Platform limitation — DSPM stores all timestamps in UTC. FR202604-1780 is the correct path. Excel workaround: =A1+TIME(4,0,0). GQL analytics board widgets also return UTC — display-layer offset can be applied in widget JS formatting if available."},
  ...
  {"case":"00983559","sfId":"500a6000014CsoDAAS","subject":"DLP unable to block sensitive data for mentioned URLs","status":"Resolution Provided","priority":"Severity 2","isClosed":false,"created":"02 Apr 2026","closed":null,"owner":"Forcepoint TS","component":"Cloud - Web","resNotes":null,"latestSfNote":"Let me try the steps and confirm — 22 Apr 2026","desc":"DLP unable to block sensitive data for specific URLs.","sfCategory":"open","isUpgrade":false,"suggestion":""},
  {"case":"00983480","sfId":"500a6000014B645AAC","subject":"[ENBD] False Positive in Data Attributes Detection — AI Mesh Refinement Required","status":"Awaiting Internal Response","priority":"Severity 2","isClosed":false,"created":"02 Apr 2026","closed":null,"owner":"Kevin O'Donovan","component":"Classification - DSPM","resNotes":null,"latestSfNote":null,"desc":"Incorrect/False Positive in Data Attributes Detection. Documents identified as HR/Legal/Confidential/Financial without actual sensitive data, causing incorrect classification. AI Mesh fine-tuning required.","sfCategory":"open","isUpgrade":true,"suggestion":"Related to mesh enbd-3.20.0 (GS-3704 Done 13 Apr). Data Attribute weights in AI Mesh over-triggering. Apply mesh change control then retest Data Attribute classifications. If FP persists post-mesh, share sample documents with Engineering for threshold calibration."},
  ...
  {"case":"00967195","sfId":"500a600000x0ZvBAAU","subject":"Unable to uninstall protector server","status":"Closed","priority":"Severity 3","isClosed":true,"created":"16 Feb 2026","closed":"22 Apr 2026","owner":"Forcepoint TS","component":"Server - DLP","resNotes":null,"latestSfNote":null,"desc":"Unable to uninstall protector server.","sfCategory":"resolved","isUpgrade":false,"suggestion":""},
    ...
    <div style={st.wrap}>
      ...
      <div style={{padding:"14px 16px 60px"}}>
        ...
        <div style={{marginTop:10,fontSize:9,color:C.inkSoft,fontFamily:"monospace",display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          <span>Forcepoint DSPM · Emirates NBD · AccountId: 0015f00000R7aqFAAR · {allCases.length} cases{addedCases.length>0?` · ${addedCases.length} added`:""} · {filtered.length} shown · synced 22 Apr 2026</span>
